...
internal class Program
{
    ...
    /// <returns></returns>
    private static long FindLocation(long seed, List<Mapping> mappings)
    {
    ...
    {
        // Initiate shortest location as max value.
        ...
        // For every seed couple
        foreach (var seedCouple in seedCouples)
        {
